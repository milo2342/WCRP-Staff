...
async function handle(interaction) {
  ...
  const staffOnly = ['activestaff','addhours','removehours','addrank','promote','promotion','bancount','clockrepair','deaths','dms','evaluate','hourmultiplier','stophourmulti','logbonus','passivehours','praise','promotions','promotioninterview','punishmenthistory','removepunishment','removeblacklist','removestaffremoval','removestrike','requesthours','staffblacklist','staffnextweek','staffremoval','staffstrike','supportteam','tmodpromos','unban','unjoin','passiveflags'];
