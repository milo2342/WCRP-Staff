...
async function sendStaffPromotionNotification({ guild, target, oldRank, newRank, by, reason, action='promotion' }) {
  ...
  if (isPromotion) {
    const promotionText = `<a:tada:7750b45770701de> Congratulations ${target}! You've been promoted to **${newRank}**. <a:tada:7750b45770701de>`;
    if (channelId) {
    ...
    const dmText = `<a:tada:7750b45770701de> Congratulations ${target}! You've been promoted to **${newRank}**. <a:tada:7750b45770701de>
